...
var sorts = [
    {
        color: "#1976D2",//#014782
        bgcolor: "#e9e8e6",
        logo: "../../../images/kehuishou.png",//RecycleableWaste.jpg
        name: "可回收物",
        content: "适宜回收利用和资源化利 用的，如：玻璃、金属、塑料、纸、衣物",
    ...
    },
    {
        color: "#EF4848",//#e73322
        bgcolor: "#c8e2f8",
        logo: "../../../images/youhai.png",//HazardouAwaste.jpg
        name: "有害垃圾",
    ...
    color:"#4CAF50",//#664035
    bgcolor: "#d6d5d4",
    logo:"../../../images/shi.png",//HouseholdfoodWaste.jpg
    name:"厨余垃圾",
    content: "日常生活垃圾产生的容易腐烂的生物质废弃物",
    desc: "剩菜剩饭、瓜皮果核、花卉绿植、过期食品等",
    action: ["纯流质的食物垃圾，如牛奶等，应直接倒进下水口","有包装物的厨余垃圾应将包装物去除后分类投放，包装物请投放到对应的可回收物或其他垃圾容器"],
},{
    color: "#F49A3D",//2c2b27
    bgcolor: "#e9e8e6",//#e9e8e6
    logo: "../../../images/gan.png",//ResidualWaste.png
    name: "其他垃圾",
