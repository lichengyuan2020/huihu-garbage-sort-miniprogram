	...
	<div class="fillcontain">
		...
		<div class="table-container">
			...
			>
				...
				<!-- <el-table-column label="邮箱地址" prop="avatar">
				</el-table-column> -->
				...
				<!-- <el-table-column label="个人签名" prop="personalizedSignature">
				</el-table-column> -->
				...
				<el-table-column label="注册时间" prop="log_time">
					<template #default="scope">
						<div>{{ scope.row.log_time }}</div>
					</template>
				</el-table-column>
				<el-table-column label="用户考试次数" prop="times">
				</el-table-column>
				<el-table-column label="用户考试总积分" prop="score">
				</el-table-column>
				<el-table-column
					label="操作"
					prop="status"
...
export default {
	...
	methods: {
		...
		handleDelete(row) {
			http2
				.post(api.userDelete + '?openid=' + row.openid, {
					openid: row.openid,
				})
				.then((res) => {
					if (res.code === 1) {
