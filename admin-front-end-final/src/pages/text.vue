<template>
	<div class="fillcontain">
		<div class="btn-wrapper">
			<div class="page-title">文本搜索记录管理</div>
		...
		<div class="table-container">
			...
			>
				...
				<!-- <el-table-column label="拍摄头像" prop="input">
				...
				<el-table-column label="搜索内容" prop="input">
				</el-table-column>
				<el-table-column label="垃圾类别" prop="result">
				</el-table-column>
				...
				<el-table-column label="文本搜索时间" prop="search_time">
					<template #default="scope">
...
export default {
	...
	methods: {
		...
		handleDelete(row) {
			http2
				.post(api.textDelete + '?openid=' + row.openid, {
					openid: row.openid,
