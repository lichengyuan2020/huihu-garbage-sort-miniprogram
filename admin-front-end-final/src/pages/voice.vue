<template>
	<div class="fillcontain">
		<div class="btn-wrapper">
			<div class="page-title">语音搜索记录管理</div>
		...
		<div class="table-container">
			...
			>
				...
				<el-table-column label="语音内容" prop="input">
				</el-table-column>
				...
				<el-table-column label="语音搜索时间" prop="search_time">
					<template #default="scope">
...
export default {
	...
	methods: {
		...
		handleDelete(row) {
			http2
				.post(api.audioDelete + '?openid=' + row.openid, {
					openid: row.openid,
		...
		async initData() {
			http.get(api.audio_search_list, {
